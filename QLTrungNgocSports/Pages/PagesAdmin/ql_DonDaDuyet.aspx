<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Share/template.Master" AutoEventWireup="true" CodeBehind="ql_DonDaDuyet.aspx.cs" Inherits="QLTrungNgocSports.Pages.PagesAdmin.ql_DonDaDuyet" %>
        ...
        <asp:ListView ID="ListView1" runat="server"
            ...
            <ItemTemplate>
                <tr style="">
                   <td><asp:CheckBox ID="CheckBox1" runat="server" /></td>
                    ...
                    <td>
                        <asp:Label ID="nguoiduyetLabel" runat="server" Text='<%# Eval("duyet") %>' />
                    </td>
                    <td>
            ...
            <EditItemTemplate>
                <tr style="">
                    ...
                    <td>
                        <asp:TextBox ID="giaLabel" runat="server" Text='<%# Bind("TongGia") %>' />
                    </td>
                    <td style="padding:5px">

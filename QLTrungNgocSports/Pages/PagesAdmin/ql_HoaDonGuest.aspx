<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Share/template.Master" AutoEventWireup="true" CodeBehind="ql_HoaDonGuest.aspx.cs" Inherits="QLTrungNgocSports.Pages.PagesAdmin.ql_HoaDonGuest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_HoaDon"
        ...
        <EditItemTemplate>
            <tr style="">
                <td>
                    <asp:TextBox ID="idTextBox" runat="server" Text='<%# Bind("id_HoaDon") %>' />
                </td>
                <td>
                    <asp:TextBox ID="tenkhTextBox" runat="server" Text='<%# Bind("unlog_TenKhachHang") %>' />
                </td>
                <td>
                    <asp:TextBox ID="diachiTextBox" runat="server" Text='<%# Bind("unlog_DiaChiKhachHang") %>' />
                </td>
                <td>
                    <asp:TextBox ID="sdtTextBox" runat="server" Text='<%# Bind("unlog_SoDienThoaiKhachHang") %>' />
                </td>
                <td>
        ...
        <ItemTemplate>
            <tr style="">
                <td>
                    ...
                    <a href="#" onclick="redir('<%# Eval("id_HoaDon") %>');">Chi tiết</a>
                </td>
                <td>
                    <asp:Label ID="idLabel" runat="server" Text='<%# Eval("id_HoaDon") %>' />
                </td>
                <td>
                    <asp:Label ID="tenkhLabel" runat="server" Text='<%# Eval("unlog_TenKhachHang") %>' />
                </td>
                <td>
                    <asp:Label ID="diachiLabel" runat="server" Text='<%# Eval("unlog_DiaChiKhachHang") %>' />
                </td>
                <td>
                    <asp:Label ID="sdtLabel" runat="server" Text='<%# Eval("unlog_SoDienThoaiKhachHang") %>' />
                </td>
                <td>
        ...
        <LayoutTemplate>
            <div class="table-responsive">
                <table runat="server">
                    <tr>
                        <td>
                            <asp:Button ID="Button1" OnClick="Button1_Click" CssClass="btn btn-outline-dark" runat="server" Text="Duyệt đơn" />
                        </td>
                    </tr>
                    <tr runat="server">
                        <td runat="server">

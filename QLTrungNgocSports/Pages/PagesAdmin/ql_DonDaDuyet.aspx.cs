...
{
    public partial class ql_DonDaDuyet : System.Web.UI.Page
    {
        ...
        public void hienthi()
        {
            ListView1.DataSource = sv.htDonDatSan1();
            ListView1.DataBind();
        }
        ...
        protected void ListView1_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            ...
            Label tt = e.Item.FindControl("nguoiduyetLabel") as Label;
            if (tt != null)
            {
                if (sv.SearchNhanVien(int.Parse(tt.Text)).Count()==1)
                {
                    foreach (var item in sv.SearchNhanVien(int.Parse(tt.Text)))
                    {
                        tt.Text = item.TenNhanVien;
                    }
                }
                //else
                //{
